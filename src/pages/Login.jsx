...
//     const reason = sessionStorage.getItem('kp_logout_reason')
//     if (reason === 'inactividad')     setLogoutMsg('Sesion cerrada por inactividad.')
//     if (reason === 'sesion-expirada') setLogoutMsg('Tu sesion expiro. Por favor ingresa de nuevo.')
...
//         </div>
//         <p className={styles.subtitle}>Portal de creditos</p>

//         {logoutMsg && (
//           <div className={styles.alertWarning}>{logoutMsg}</div>
//         )}
//         {error && (
...
//           Tu sesion se cierra automaticamente tras {import.meta.env.VITE_INACTIVITY_TIMEOUT_MINUTES || 10} min de inactividad.
//         </p>
//       </div>
//     </div>
//   )
